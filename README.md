...
### Experiment set-up. Note, you need to change lnvc parameter according to your setup. Start yakuake. Open three sessions. In each session execute the required commands:
1. Computer LEFT:
    1. Launch nicopose `roslaunch nicopose pose.launch llabel:=A lnvc:=M`
    2. Launch logging: `rostopic echo /rosout | grep msg`
